	<div id="add_job_title_least" class="modal hide fade" tabindex="-1"  role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
<div class="modal-header">
		<?php $est_queryu=mysql_query("select Max(id) from grade_job_title")or die(mysql_error());
					...
					$row=mysql_fetch_array($est_queryu);
					  $addd=$row[0] + 1;                                                                                                        
										...
										?>
				<div class="alert btn-success"><strong style="color:white">Add Job Title</strong></div>
...
<select name='Level_one_job' required  onchange="show_me(this.value)">
		...
		<option value="<?php echo $row[0]; ?>"><?php echo $row[1]; ?> </option>
            ...
            <div class="control-group">
				<div class="controls">
				<button name="submit_add_least" type="submit" class="btn btn-sucess"><i class="icon-save icon-large"></i>&nbsp;Save</button>
				</div>
			</div>
