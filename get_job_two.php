...
<select name='level_three_job_title'  onChange="show_job(this.value)" >
	  
		<option value="" ></option>
	    <?php while($row_job=mysql_fetch_array($sam)) {  ?>
		  
		<option style="color:BLACK"value="<?php echo $row_job[1]; ?>"><?php echo $row_job[2]; ?> </option>
			 ...
			 <div  class="control"  id="mam"><b></b></div>	 
</body>
</html>