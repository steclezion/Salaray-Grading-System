				...
				<div class="container">
					<a href="index.html" id="branding">
						...
						<ul class="menu">
							...
							<li class="menu-item current-menu-item"><a href="about.php">Salary calulation</a></li>
							<li class="menu-item"><a href="gallery.php">Assign Grade</a></li>
							<li class="menu-item"><a href="download.php">Download</a></li>
							<li class="menu-item"><a href="blog.php">Blog</a></li>
							<li class="menu-item"><a href="contact.php">Logout</a></li>
						</ul><!-- .menu -->
					</nav> <!-- .main-navigation -->
							...
							<div class="col-md-7">
								<div class="content">
									...
									<div class="post">
										...
										<div class="featured-image">
											<img src="dummy/Band Name/650238-rock-music-picture.jpg" alt="">
										</div>
									...
									<div class="post">
										...
										<div class="featured-image">
											<img src="dummy/Band Name/858431-music-wallpaper.jpg" alt="">
										</div>
